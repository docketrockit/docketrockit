...
import { type getMerchantUsers } from '@/actions/merchant/users';
import { getStatusIcon } from '@/lib/utils';
import { getColumns } from './UsersTableColumns';
import { UsersTableFloatingBar } from './UsersTableFloatingBar';
import { useUsersTable } from './UsersTableProviders';
import { UsersTableToolbarActions } from './UsersTableToolbarActions';
import { MerchantUser } from '@/types/merchant/user';
import { UsersTableProps } from '@/schemas/merchant/users';

export const UsersTable = ({ merchantUsersPromise, user }: UsersTableProps) => {

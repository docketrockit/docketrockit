...
interface MerchantsTableContextProps {
    featureFlags: FeatureFlagValue[];
    setFeatureFlags: React.Dispatch<React.SetStateAction<FeatureFlagValue[]>>;
}

const MerchantsTableContext = createContext<MerchantsTableContextProps>({
    featureFlags: [],
    setFeatureFlags: () => {}
});
...
export const useMerchantsTable = () => {
    ...
    if (!context) {
        throw new Error(
            'useMerchantsTable must be used within a MerchantsTableProvider'
        );
    }
    return context;
};

export const MerchantsTableProvider = ({
    children
